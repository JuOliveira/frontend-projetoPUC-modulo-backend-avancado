                ...
                <div className="c-list-item">
                  ...
                  <div className="c-list-item-content">
                    ...
                    <div>
                      ...
                      {animeItem.episodes !== 0 && <p className="list-item-text list-item-margin"><b>Episodes: </b>{animeItem.episodes}</p>}
                      ...
                      <p className="list-item-text list-item-margin"><b>Series Status: </b>{status[animeItem.status]}</p>
