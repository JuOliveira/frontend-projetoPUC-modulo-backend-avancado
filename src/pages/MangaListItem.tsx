...
import { manga_user_status, status } from "../utils/constants"
                ...
                <div className="c-list-item">
                  ...
                  <div className="c-list-item-content">
                    ...
                    <div>
                      ...
                      {mangaItem.volumes !== 0 && <p className="list-item-text list-item-margin"><b>Volumes: </b>{mangaItem.volumes}</p>}
                      {mangaItem.chapters !== 0 && <p className="list-item-text list-item-margin"><b>Chapters: </b>{mangaItem.chapters}</p>}
                      ...
                      <p className="list-item-text list-item-margin"><b>Series Status: </b>{status[mangaItem.status]}</p>
